...
import { getScaleNotes, SCALES, degreeToChord, NOTE_FR } from '../utils/music.js'
...
export default function Cantiques() {
  ...
  // For selected cantique: compute scale notes for keyboard display
